...
export function initCharts() {
    ...
    charts.metrics = new Chart(metricsCtx, {
        type: 'bar',
        data: {
            labels: ['Events', 'Frames (k)', 'CPU', 'Mem', 'Latency (ms)'], // Added Latency
            datasets: [{
                label: 'Current',
                data: [0, 0, 0, 0, 0], // Added 0 for Latency
                backgroundColor: ['#e74c3c', '#3498db', '#f39c12', '#2ecc71', '#9b59b6'] // Added color for Latency
            }]
        },
